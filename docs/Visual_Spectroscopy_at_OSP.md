---
layout: default
title: Visual Spectroscopy at OSP
author: Rob Brown, with Akarsh Simha contributing where noted
---

*This year, Oregon Star Party saw a number of contributors to this website gathered together.*

Hi, I'm Rob Brown, the newest of those contributors, a retired Optical Engineer, amateur telescope maker and visual observer. Starting 2026, I am also co-chair of the [First Light Telescope Conference](https://www.firstlightconference.org/) (formerly known as the [Portland Alt/Az Workshop](https://sites.google.com/site/copyclassicsite/howardbanich-homepage)) a gathering of amateur telescope makers and visual observers from around the world, in a hybrid format. I also make some novel tools for visual observers, which you can buy on [my website quinsightspectre.com](https://www.quinsightspectre.com/). One of those is the Spectre, a high-performance visual spectroscope for amateur astronomers.

Akarsh Simha has a Spectre spectroscope but had not used it, so I took the time to train him. Of course, doing that at the Oregon Star Party meant that there would be an audience, one very interested in seeing the spectra of various stars. So we put together a brief observing program in which we looked at three very different stars and a planetary nebula. We looked at Altair, Mirach, and Rasalgethi. Howard Banich gave us a very brief history of William Huggins and his first observation of the Cat's Eye Nebula (<x-dso>NGC 6543</x-dso>) in his spectroscope, then we looked at it too. But where Huggins was using an 8-inch refractor, we had the pleasure of using a 28-inch reflector.
...
> "Mirach is a single, aging red giant with a stellar classification of M0 III. It is currently on the asymptotic giant branch of its evolution. The star has an estimated 2.49 times the mass of the Sun.
> Having exhausted the supply of hydrogen at its core, the outer envelope of the star has expanded to around 86 times the size of the Sun. It is radiating 1,675 times the luminosity of the Sun at an effective temperature of 3,762 K.
> Mirach is suspected of being a semiregular variable star, with an apparent visual magnitude varies from +2.01 to +2.10.
> Since 1943 the **spectrum of this star has been one of the stable anchor points by which other stars are classified**." — *Wikipedia*
...
I learned from Akarsh that the broad bands are induced by molecular vibrations coupled with the electronic transitions. One can think of the titanium and oxygen atoms being coupled on a spring,
with that spring exchanging energy with the quantum leaps of the electrons to produce broad energy bands. These dark curtains are superimposed on a background of fine spectral lines, and all of them are spread across the entire visible spectrum. Rasalgethi has a very similar spectrum to the much brighter Betelgeuse, and in the 28-inch the view was comparable to what I see in my 12-inch on the brighter star. In other words, spectacular!
...
For more information about the spectra of stars, look in [here](/spectra.htm) and [here](/questions.htm) for the original articles by Jim Shields.
...
Then it was time to go find the Cat's Eye Nebula (NGC 6543), and this gave Howard some time to give us the background of [William Huggins's](https://en.wikipedia.org/wiki/William_Huggins) discovery. Adding to the anticipation of the view was that Howard did not detail what Huggins saw, only that what he saw answered the prevailing question of the day and ushered in a new era of astronomy.

*Spoiler alert: I'm going to explain what we saw and what Huggins saw.*

I saw three vertical emission lines in the blue-green. The two brightest lines were adjacent and at times could not be resolved from each other; the third line was much fainter and well separated.
Akarsh wanted to know the source of these lines. We were pretty sure that we were seeing the $$\text{[O III]}$$ (doublet) and hydrogen beta ($$\text{H}\beta$$), so the obvious thing to do was grab $$\text{[O III]}$$ and hydrogen beta filters to see what lines were passed and blocked by each.
