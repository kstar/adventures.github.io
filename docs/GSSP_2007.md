...
-------|----|-----|------|-----|-------|------
  ...
  <x-dso-link simbad="NGC 3556:[HK83] 139">HK 139</x-dso-link> in M 108|  11 11.5|  +55 40|  |  |  Cam| A few brighter patches  or knots are visible along the major axis of <x-dso-link>M108</x-dso-link> with a prominent HII knot  along the W side.
  ...
  <x-dso-link simbad="NGC 4449:[CM69] 21">CM 21</x-dso-link> in NGC 4449|  12 28.2|  +44 06|  |  |  CVn| Several giant HII  regions are visible, the brightest (CM 21) is a well-defined patch on the N edge of  the gx, 1.5' from the center.
